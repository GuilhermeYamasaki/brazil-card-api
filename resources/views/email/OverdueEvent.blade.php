...
<head>
    ...
    <title>Pagamento Atrasado</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>Gostariamos de informar que o pagamento de <strong>R$ {{ number_format($data['amount'], 2, ',', '.') }}</strong> para {{ $data['recipientName'] }}
            ainda não foi realizado e está atrasado.
        </p>
